    ...
    <div className="bg-lime-50 h-screen flex items-center justify-center">
      <div className="bg-white p-12 rounded-lg shadow-md text-center">
        <div className="rounded-full h-72 w-72 bg-[#F8FAF5] mx-auto mb-6 flex items-center justify-center">
          <i className="checkmark" style={checkmarkStyle}>
            ✓
          </i>
        </div>
        ...
        <p className="text-gray-700 text-lg">
          ...
          <span className="text-[#9ABC66] font-semibold">
            {timePeriod === 1
              ? " One Month "
              : timePeriod === 3
              ? " Three Months "
          ...
          yoga plan!
          <br /> Get ready to embark on a journey of health and well-being.
          We'll be sending you class details shortly.
        </p>
      </div>
    </div>
  );
