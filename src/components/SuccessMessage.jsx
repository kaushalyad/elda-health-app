...
const SuccessMessage = ({ timePeriod }) => {
  ...
  return (
    <div className="bg-lime-50 h-screen flex items-center justify-center">
      <div className="bg-white  rounded-lg shadow-md text-center mobile:w-[70%] mobile:px-12 mobile:pt-12 mobile:text-6xl mobile:font-bold tablet:w-[70%] tablet:p-12 p-12 w-[55%] ">
